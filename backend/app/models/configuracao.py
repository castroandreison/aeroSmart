...
class Configuracao(Base):
    ...
    def chaves_padrao(cls):
        return {
            ...
            "valor_pago_kwh": {"valor": "0.50", "tipo": "decimal", "descricao": "Valor pago pelo kWh (fatura do aeroclube)"},
            "valor_cobrado_kwh": {"valor": "0.80", "tipo": "decimal", "descricao": "Valor cobrado pelo kWh (balizamento)"},
            "taxa_fixa_solicitacao": {"valor": "10.00", "tipo": "decimal", "descricao": "Taxa fixa de solicitação (R$)"},
